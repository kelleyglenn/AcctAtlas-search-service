...
INSERT INTO search.search_videos (
    ...
    ('10000000-0000-0000-0000-000000000001', 'RngL8_3k0C0',
     ...
     'Phil',
     'https://img.youtube.com/vi/RngL8_3k0C0/mqdefault.jpg', 632,
    ...
    ('10000000-0000-0000-0000-000000000002', 'nQRpazbSRf4',
     ...
     'Audit the Audit',
     'https://img.youtube.com/vi/nQRpazbSRf4/mqdefault.jpg', 1024,
    ...
    ('10000000-0000-0000-0000-000000000003', 'ULjtPKeh9Co',
     ...
     'Long Island Audit',
     'https://img.youtube.com/vi/ULjtPKeh9Co/mqdefault.jpg', 1847,
     ARRAY['FIRST', 'FOURTH']::VARCHAR[], ARRAY['POLICE']::VARCHAR[],
    ...
    ('10000000-0000-0000-0000-000000000004', 'AJi0LgnoIJA',
     ...
     'Fricn Media',
     'https://img.youtube.com/vi/AJi0LgnoIJA/mqdefault.jpg', 945,
    ...
    ('10000000-0000-0000-0000-000000000005', 'OdsTAYnC8Kc',
     ...
     'The Random Patriot',
     'https://img.youtube.com/vi/OdsTAYnC8Kc/mqdefault.jpg', 512,
    ...
    ('10000000-0000-0000-0000-000000000006', '-kNacBPsNxo',
     ...
     'Mexican Padilla',
     'https://img.youtube.com/vi/-kNacBPsNxo/mqdefault.jpg', 1203,
    ...
    ('10000000-0000-0000-0000-000000000007', 'IX_8Epjcp54',
     ...
     'News Now Houston',
     'https://img.youtube.com/vi/IX_8Epjcp54/mqdefault.jpg', 756,
     ARRAY['FIRST']::VARCHAR[], ARRAY['POLICE', 'GOVERNMENT']::VARCHAR[],
    ...
    ('10000000-0000-0000-0000-000000000008', 'hkhrXPur4ws',
     ...
     'Amagansett Press',
     'https://img.youtube.com/vi/hkhrXPur4ws/mqdefault.jpg', 1531,
    ...
    ('10000000-0000-0000-0000-000000000009', 'QgkT4epLRcw',
     ...
     'Livingston Audits',
     'https://img.youtube.com/vi/QgkT4epLRcw/mqdefault.jpg', 423,
    ...
    ('10000000-0000-0000-0000-000000000010', 'FwvZCn0uLiw',
     ...
     'The Random Patriot',
     'https://img.youtube.com/vi/FwvZCn0uLiw/mqdefault.jpg', 2145,
     ARRAY['FIRST']::VARCHAR[], ARRAY['GOVERNMENT']::VARCHAR[],
